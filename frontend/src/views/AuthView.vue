...
<template>
    <div class="pa-0 flex items-center justify-center backdrop-blur-3xl bg-cover! bg-center! bg-no-repeat!"
        ...
        <AuthGlass v-if="isAuth" />
        <ForgotPasswordGlass v-else :changePasswordId="route.params.id" />
    </div>
</template>
