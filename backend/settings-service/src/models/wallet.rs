...
///
/// This struct maps to the `wallets` table and contains wallet information
/// for managing user budgets and expenses.
///
/// # Fields
///
...
/// * `currency` - Currency code for this wallet (independent from user account currency)
/// * `wallet_type` - Type/category of the wallet (e.g., general, savings, business, personal)
/// * `created_at` - Timestamp when the wallet was created
/// * `updated_at` - Timestamp when the wallet was last modified
...
/// * `balance` - Initial balance (optional, defaults to 0.00)
/// * `currency` - Currency code for the wallet
/// * `wallet_type` - Type/category of the wallet (optional, defaults to General)
#[derive(Deserialize)]
...
/// Represents updates to an existing wallet
///
